...
async def ws_message(ws, message, opcode):
    ...
    # Receiving any message implicitly updates activity for idle_timeout
    ...
    if is_text and message_content:
        try:
            ...
            if message_type == "keepalive":
                ...
                return # Just ignore it, receiving it resets server idle timer
...
if __name__ == "__main__":
    ...
    ws_options = {
        ...
        "upgrade": ws_upgrade,
        "open": ws_open,
        "message": ws_message, # Now handles keepalive
        "close": ws_close,
    }
